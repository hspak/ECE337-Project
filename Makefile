...
COMPONENT_FILES	:= cla_4bit.sv cla_16bit.sv adder_1bit.sv ud_flex_counter.sv mult16by4.sv fader_state.sv amp_clip.sv amp_comp.sv clk_div.sv flanger_adder.sv flex_buffer.sv flex_counter.sv fader.sv flanger.sv

# Specify the name of the top level file (do not include the source folder in the name)
# NOTE: YOU WILL NEED TO SET THIS VARIABLE'S VALUE WHEN WORKING WITH HEIRARCHICAL DESIGNS
# AND THE AUTOMATED GRADING SYSTEM
TOP_LEVEL_FILE	:= daf.sv

# Specify the filepath of the test bench you want to use (ie. tb_top_level.sv)
# (do not include the source folder in the name)
TEST_BENCH	:= tb_daf.sv
